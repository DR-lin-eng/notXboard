...
class NodePlanController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (count($ownedNodeIds) !== count($nodeIds)) {
            return response()->json(['success' => false, 'error' => 'node_ids contains nodes you do not own'], 403);
        }
